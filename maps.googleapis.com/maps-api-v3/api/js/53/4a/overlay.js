google.maps.__gjsload__("overlay", function (_) {
  var ky = function (a) {
    ...
    Boa = function (a, b) {
      ...
      a.bindTo("panes", g);
      d.Oa = [
        _.M(a, "panes_changed", c),
        _.M(g, "zoom_changed", c),
        _.M(g, "offset_changed", c),
        _.M(b, "projection_changed", c),
        _.M(g, "projectioncenterq_changed", c),
      ];
      c();
      b instanceof _.zf
        ? (_.Q(b, "Ox"), _.P(b, 148440))
        : b instanceof _.hh && (_.Q(b, "Oxs"), _.P(b, 181451));
    },
    Foa = function (a) {
      if (a) {
        var b = a.getMap();
        if (Coa(a) !== b && b && b instanceof _.zf) {
          var c = b.__gm;
          c.overlayLayer
            ? (a.__gmop = new Doa(b, a, c.overlayLayer))
            : c.h.then(function (d) {
                d = d.ka;
                var e = new my(b, d);
                d.tb(e);
  ...
  _.Ue("overlay", {
    ...
    preventMapHitsAndGesturesFrom: function (a) {
      ...
      a.addEventListener("mousedown", _.bf);
