google.maps.__gjsload__("map", function (_) {
  var dma = function (a) {
    ...
    gx = function (a) {
      return (a = _.qm(a.g)) && _.S(a.m, 2) && _.S(_.I(a.m, 2, fx).m, 3, lma)
        ? _.I(_.I(a.m, 2, fx).m, 3, dma, lma)
        : null;
    },
    mma = function (a) {
      if (!a.g) return !1;
    ...
    rma = function (a) {
      ...
      new _.Si(a, "focus", function () {
        b.style.opacity = _.Ti
          ? _.Ri(a, ":focus-visible")
            ? 1
            : 0
          : !1 === _.Ui
          ? 0
    ...
    vma = function (a) {
      if (!a) return null;
      a = a.toLowerCase();
      return tma.hasOwnProperty(a)
        ? tma[a]
        : uma.hasOwnProperty(a)
        ? uma[a]
        : null;
    },
    wma = function (a, b, c) {
    ...
    Bma = function () {
      ...
      return function (c, d) {
        if (c && d) {
          if (0.999999 > kx(c, d)) return (b = !1);
          c = wma(c, (a - 1) / 2);
          return 0.999999 < kx(c, d) ? (b = !0) : b;
        }
      };
    },
    Cma = function (a, b) {
    ...
    Dma = function (a, b, c) {
      ...
      if ((b = Cma(b, c))) d = b;
        ...
        for (var e in a.params)
          (b = _.An(d)), _.un(b, e), (c = a.params[e]) && _.vn(b, c);
      return d;
    },
    ...
    Fma = function (a, b, c, d, e) {
      ...
      if (e) {
        ...
        if ((c = e.cw) && !_.eb(c))
          for (
            h || ((h = new _.yn()), _.zn(h, 26), f.push(h)),
    ...
    mx = function (a, b, c, d, e, f) {
      ...
      if (this.j) {
        ...
        g.push(q);
        b = { Ad: Ema(k, l, m, p, g, b, e, f), Tf: c, scale: d };
        h.call(a, b);
      }
    },
    Gma = function (a, b, c) {
    ...
    Hma = function (a) {
      ...
      if (
        a.h &&
        ((b = _.fr(_.Vr(a.D, { ia: c + 0.5, ja: d + 0.5, ta: e }), null)),
        !yma(a.h, b))
      ) {
        a.o = !0;
      ...
      (c = a.G({ ia: c, ja: d, ta: e }))
        ? ((c = _.Un(
            _.Un(_.Un(new _.On(_.Aka(a.F, c)), "x", c.ia), "y", c.ja),
            "z",
            g
          )),
          1 != b && _.Un(c, "w", a.D.size.ba / b),
          f && (b *= 2),
          1 != b && _.Un(c, "scale", b),
          a.g.setUrl(c.toString()).then(a.C))
        : a.g.setUrl("").then(a.C);
    },
    ...
    qx = function (a, b, c, d) {
      ...
      if ("satellite" == b) {
        ...
        b = new _.Zr({ ba: 256, da: 256 }, e ? 45 : 0, d.heading || 0);
        return new Ima(
          h,
          f && 1 < _.Lk(),
          _.Iv(d.heading),
    ...
    Lma = function (a) {
      function b(c, d) {
        ...
        var e = d.Ad.clone();
        _.zn(_.pu(_.zu(e)), c);
        return { scale: d.scale, Tf: d.Tf, Ad: e };
      }
      return function (c) {
        var d = qx(a, "roadmap", a.g, { oy: !1, Jd: b(3, c.Jd().get()) }),
          e = qx(a, "roadmap", a.g, { Jd: b(18, c.Jd().get()) });
        d = new ox([d, e]);
        c = qx(a, "roadmap", a.g, { Jd: c.Jd().get() });
        return new Jma(d, c);
      };
    },
    Mma = function (a) {
      return function (b, c) {
        var d = b.Jd().get(),
          e = qx(a, "satellite", null, { heading: b.heading, Jd: d, Ft: !1 });
        b = qx(a, "hybrid", a.g, { heading: b.heading, Jd: d });
        return new ox([e, b], c);
      };
    },
    Nma = function (a, b) {
      return new lx(
        Mma(a),
        a.g,
        "number" === typeof b ? new _.cr(b) : a.o,
    ...
    Rma = function (a, b, c) {
      ...
      if ("hybrid" == b)
        for (
          b = Nma(a), b.g = {}, d = _.A(d), c = d.next();
          !c.done;
          c = d.next()
        )
          (c = c.value), (b.g[c] = Nma(a, c));
      else if ("satellite" == b)
        for (
          b = Pma(a), b.g = {}, d = _.A(d), c = d.next();
          !c.done;
          c = d.next()
        )
          (c = c.value), (b.g[c] = Pma(a, c));
      else
        b =
          "roadmap" == b && 1 < _.Lk() && c.nz
            ? new lx(
                Lma(a),
                a.g,
                a.o,
    ...
    cna = function (a, b, c, d) {
      ...
      _.Jr(c.Tg, {
        ...
        zd: function (f) {
          ...
          f = f.Hh;
          3 === h.button
            ? f || xx(e, "rightclick", g, h.Ea)
            : f
            ? xx(e, "dblclick", g, h.Ea, _.lr("dblclick", g, h.Ea))
            : xx(e, "click", g, h.Ea, _.lr("click", g, h.Ea));
        },
        yh: {
          df: function (f, g) {
    ...
    yx = function (a, b, c) {
      function d() {
        ...
        if (_.Wd(t) && u) {
          ...
          var x = _.Cj(r, { ba: g / 2, da: h / 2 });
          u = _.Cm(_.er(u, q), x);
          (u = _.fr(u, q)) ||
            console.warn("Unable to calculate new map center.");
          x = a.getCenter();
          p.get("isInitialized") && u && x && t && t === a.getZoom()
            ? ((p = _.Fm(r, _.er(x, q))),
              (q = _.Fm(r, _.er(u, q))),
              a.panBy(q.ba - p.ba, q.da - p.da))
    ...
    fna = function (a, b, c, d) {
      return new _.Wr(function (e, f) {
        e = new _.Tr(a, b, c, _.hs(e), f, { al: !0 });
        c.tb(e);
        return e;
      }, d);
    },
      ...
      function e(f, g, h) {
        ...
        if (k && null != l && m) {
          var p = a.getTilt() || 0,
            q = a.getHeading() || 0,
            r = _.Bj(l, p, q);
          f = _.Bm(_.er(k, m), _.Cj(r, { ba: f, da: g }));
          c.Pc({ center: f, zoom: l, heading: q, tilt: p }, h);
        }
      }
      ...
      _.M(b, "tiltrotatebynow", function (d, e) {
        ...
        if (f && null != g && h) {
          var k = a.getTilt() || 0,
            l = a.getHeading() || 0;
          c.Pc(
            { center: _.er(f, h), zoom: g, heading: l + d, tilt: k + e },
            !1
          );
        }
      });
    ...
    vna = function (a, b, c) {
      var d = a.__gm;
      b = new Dx(a.mapTypes, d.j, b, d.Ug, c);
      b.bindTo("heading", a);
    ...
    wna = function (a, b) {
      if ((a.h = b))
        a.o && a.set("heading", a.o), (b = a.get("mapTypeId")), a.xk(b);
    },
    Ex = function () {},
    xna = function (a, b) {
      this.g = a;
    ...
    Bna = function (a, b, c) {
      if (!a.isEmpty()) {
        ...
        (e || g.length || h) &&
          _.nn(b, "maptypeid_changed", function () {
            var l = c.j.get();
    ...
    Ix = function (a, b) {
      ...
      this.ka = b(function (e, f) {
        ...
        (c.h && f.min.equals(c.h.min) && f.max.equals(c.h.max)) ||
          ((c.h = f), c.o());
        if (!c.g) {
          c.g = !0;
          try {
        ...
        if (a.j ? !a.g : !a.g || d || f) {
          ...
          try {
            ...
            a.map.get("isFractionalZoomEnabled") ||
              Math.round(k) === k ||
              "number" !== typeof k ||
              (_.Q(a.map, "BSzwf"), _.P(a.map, 149837));
            if (g && h && null != k && !isNaN(h.lat()) && !isNaN(h.lng())) {
              var l = _.er(h, g),
                m = !b || b.zoom != k || d || f;
              a.ka.Pc({ center: l, zoom: k, tilt: c, heading: e }, a.F && m);
            }
          } finally {
            a.D = !1;
          }
        ...
        b &&
          b.forEach(function (c) {
            c &&
              ...
              vma(c.featureType) &&
              (_.Q(a, c.featureType),
              c.featureType in Dna && _.P(a, Dna[c.featureType]));
          });
      } catch (c) {}
    },
    Hna = function (a) {
      ...
      for (var b = [], c = _.A(a), d = c.next(); !d.done; d = c.next()) {
        ...
        null != e &&
          null == h &&
          _.ke(_.je("invalid style feature type: " + e, null));
        e = f && Fna[f.toLowerCase()];
        (e = null != e ? e : null) && d.push("s.e:" + e);
        null != f &&
          null == e &&
          _.ke(_.je("invalid style element type: " + f, null));
        if (g)
      ...
      b = b.join(",");
      return b.length > (_.Zi[131] ? 12288 : 1e3)
        ? (_.be("Custom style string for " + a.toString()), "")
        : b;
    },
    Jx = function () {},
    Kx = function (a, b) {
      ...
      b =
        void 0 === b
          ? ((c["X-Goog-Api-Key"] =
              (null == (Ina = _.td) ? void 0 : _.zd(Ina)) || ""),
            (c["X-Goog-Maps-Client-Id"] =
              (null == (Jna = _.td) ? void 0 : _.L(Jna.m, 7)) || ""),
    ...
    Mx = function (a, b, c, d, e, f, g, h) {
      ...
      this.Ba = new _.Hi(function () {
        ...
        if (!l || _.xm(l).equals(_.wm(l))) _.qg(k.h);
          ...
          (l.Ua.hi !== l.Ua.lo && l.Ha.hi !== l.Ha.lo) || _.qg(k.h);
          var m = k.D;
          var p = Lna(k);
          var q = k.get("bounds"),
            r = Lx(k);
          ...
          if ((p = k.D = p)) {
            if (
              ((m = p != m) ||
                (m = (m = k.get("bounds")) ? (k.C ? !k.C.Xf(m) : !0) : !1),
              m)
            ) {
              ...
              p &&
                ...
                (q = (q && k.get("heading")) || 0),
                _.D(m.m, 8, q),
                _.Zi[43] ? _.D(m.m, 11, 78) : _.Zi[35] && _.D(m.m, 11, 289),
                (q = k.get("baseMapType")) && q.gk && k.o && _.D(m.m, 6, q.gk),
                (p = k.C = wma(p, 1, 10)),
                (q = _.K(m.m, 1, _.so)),
                (r = _.to(q)),
                _.qo(r, p.getSouthWest().lat()),
                _.ro(r, p.getSouthWest().lng()),
                (q = _.uo(q)),
                _.qo(q, p.getNorthEast().lat()),
                _.ro(q, p.getNorthEast().lng()),
                k.G && k.H
                  ? ((k.H = !1),
                    _.D(m.m, 12, 1),
                    m.setUrl(k.W.substring(0, 1024)),
                    _.D(m.m, 14, k.G))
                  : _.D(m.m, 12, 2),
                Nna(m, t, k.h));
            }
    ...
    Nna = function (a, b, c) {
      ...
      _.rv(
        _.Kk,
        _.ew + "/maps/api/js/ViewportInfoService.GetViewportInfo",
        _.Rj,
        d,
        function (e) {
          try {
    ...
    Ox = function (a, b, c, d, e) {
      ...
      this.bounds = a && {
        min: a.min,
        max: a.min.g <= a.max.g ? a.max : new _.yj(a.max.g + 256, a.max.h),
        qF: a.max.g - a.min.g,
        rF: a.max.h - a.min.h,
      };
      (d = this.bounds) && c.width && c.height
        ? ((a = _.v(Math, "log2").call(Math, c.width / (d.max.g - d.min.g))),
          (c = _.v(Math, "log2").call(Math, c.height / (d.max.h - d.min.h))),
          (e = Math.max(
            b ? b.min : 0,
            (void 0 === e ? 0 : e)
      ...
      this.O = function (e) {
        ...
        if (g.Af) "Escape" === e.key && g.rn(e);
          ...
          if (_.tv(e) || _.uv(e))
            1 >= c.g.size
              ? (k = null)
              : ((h = [].concat(_.oa(_.v(c.g, "keys").call(c.g)))),
                (k = h.length),
                (k = h[(h.indexOf(f) - 1 + k) % k])),
              (h = !0);
          else if (_.vv(e) || _.wv(e))
            1 >= c.g.size
              ? (k = null)
              : ((h = [].concat(_.oa(_.v(c.g, "keys").call(c.g)))),
                (k = h[(h.indexOf(f) + 1) % h.length])),
              (h = !0);
          e.altKey && (_.sv(e) || e.key === _.gla)
            ? g.ik(e)
            : !e.altKey && _.sv(e) && ((h = !0), g.sn(e));
          k &&
            k !== f &&
            (Sx(c, c.g.get(f), !0),
            Tx(c, c.g.get(k), !0),
    ...
    Qx = function (a, b) {
      if (b.targetElement) {
        ...
        for (var c = _.A(a.D), d = c.next(); !d.done; d = c.next())
          d.value.remove();
        a.D = [];
    ...
    Rx = function (a, b) {
      if (!a.j || a.j === b) {
        ...
        d && a.g.has(d)
          ? Tx(a, b, c)
          : (Sx(a, b, c),
            (b = _.v(a.g, "values").call(a.g).next().value),
            Tx(a, b, c));
      }
    },
    Tx = function (a, b, c) {
    ...
    Rna = function (a, b) {
      ...
      for (var e = b.next(); !e.done; e = b.next())
        (e = e.value), (c.o.get(e).isEnabled = _.v(d, "includes").call(d, e));
      d = _.A(d);
      for (e = d.next(); !e.done; e = d.next())
        (b = e.value),
          c.o.has(b) || c.o.set(b, new _.Gj({ map: a, featureType: b }));
      c.Z = !0;
    },
    Sna = function (a, b) {
      function c(d) {
    ...
    Yx = function (a, b) {
      ...
      a &&
        ((this.g = _.Vn(this.h).createElement("div")),
      ...
      this.D &&
        b &&
        (this.j = _.lf(b, "mousemove", (0, _.Qa)(this.C, this), !0));
      this.title_changed();
    },
    ...
    Yna = function (a, b) {
      return { ab: a.ka.qd(b.ab), radius: b.radius, zoom: a.ka.Dc().zoom };
    },
        ...
        zd: function (q) {
          ...
          q.Hh &&
            ...
            p.enabled() &&
              ((q = p.h(4)),
              "none" !== q &&
                ((t = p.ka.Dc().zoom + (t ? -1 : 1)),
                p.g() || (t = Math.round(t)),
                (r = "zoomaroundcenter" === q ? p.ka.Dc().center : p.ka.qd(r)),
                Xna(p.ka, t, r),
                p.de(1))));
        },
      };
    ...
    $na = function (a, b) {
      return { ab: b.ab, oC: a.ka.Dc().tilt, nC: a.ka.Dc().heading };
    },
    aoa = function (a, b, c) {
      this.h = a;
      this.j = b;
    ...
    boa = function (a, b, c) {
      ...
      var d = a.width || 1,
        e = a.height || 1;
      a = new aoa(b.center.g / d, b.center.h / e, 0.5 * Math.pow(2, -b.zoom));
      d = new aoa(c.center.g / d, c.center.h / e, 0.5 * Math.pow(2, -c.zoom));
      this.gamma = (d.g - a.g) / a.g;
      this.Ib = _.v(Math, "hypot").call(
        Math,
        (0.5 *
          _.v(Math, "hypot").call(Math, d.h - a.h, d.j - a.j, d.g - a.g) *
          (this.gamma
      ...
      if (this.g.zoom < this.Qa.zoom)
        for (;;) {
          ...
          this.Hi.push(
            (Math.abs(b - this.g.zoom) / Math.abs(this.Qa.zoom - this.g.zoom)) *
              this.Ib
          );
        }
    ...
    ioa = function (a, b, c, d) {
      ...
      var k = a.D;
      k &&
        (a.j.style[k] = a.o.style[k] =
          "translate(" + a.offset.ba + "px," + a.offset.da + "px)");
      a.options.Hn || (a.j.style.willChange = a.o.style.willChange = "");
      k = a.getBoundingClientRect(!0);
      for (
        var l = _.A(_.v(Object, "values").call(Object, a.Ca)), m = l.next();
        !m.done;
        m = l.next()
      )
        m.value.Kb(
          ...
          g,
          e,
          { ba: k.width, da: k.height },
          { cB: d, Gh: !0, timestamp: c }
        );
    },
    fy = function (a, b, c) {
      return {
        center: _.Bm(
          c,
          _.Cj(
            _.Bj(b, a.tilt, a.heading),
            _.Fm(_.Bj(a.zoom, a.tilt, a.heading), _.Cm(a.center, c))
          )
        ),
        zoom: b,
        heading: a.heading,
    ...
    koa = function (a, b, c) {
      return a.g.oa.heading !== b.heading && c
        ? 3
        : a.o
        ? a.g.oa.zoom !== b.zoom && c
          ? 2
          : 1
        : 0;
    },
    ...
    loa = function (a, b, c, d) {
      ...
      this.g = 0.5 * this.Ib * d;
      this.h = 0.5 * this.Ib * b;
      this.j = a;
      this.Qa = {
    ...
    moa = function (a, b, c, d) {
      ...
      b = a.zoom - b.zoom;
      c = 0 >= c ? 0 : b / c;
      this.Ib = (1e3 * Math.sqrt(Math.abs(c))) / 0.4;
      this.g = (this.Ib * c) / 2;
      c = a.zoom + this.g;
      b = fy(a, c, d).center;
      this.j = a;
      this.h = d;
      this.Qa = { center: b, heading: a.heading, tilt: a.tilt, zoom: c };
    },
    noa = function (a, b, c) {
      this.Hi = [];
      var d =
    ...
    Xna = function (a, b, c, d) {
      ...
      f &&
        ((b = fy(f, b, c)),
        (d = a.h(a.g.getBoundingClientRect(!0), f, b, d)),
        a.controller.Qg(d));
    },
    iy = function (a, b) {
      var c = a.Dc();
    ...
    roa = function (a, b, c) {
      ...
      return new poa(
        function (f) {
          return new joa(a, f, { Hn: e });
        },
        function (f, g, h, k) {
          return new doa(new boa(f, g, h), { fd: k, maxDistance: d ? 1.5 : 0 });
        },
        b
      );
    },
    ...
    voa = function (a) {
      ...
      if (b) {
        ...
        _.of(a, "embedreportoncelog_changed", function () {
          voa(a);
        });
    },
    woa = function (a) {
      ...
      if (b) {
        ...
        _.of(a, "embedfeaturelog_changed", function () {
          woa(a);
        });
    },
    jy = function () {};
  ...
  nx.prototype.release = function () {
    for (var a = _.A(this.h), b = a.next(); !b.done; b = a.next())
      b.value.release();
    this.j();
  };
  ox.prototype.Ic = function (a, b) {
    ...
    return new nx(c, d, this.Xa.size, this.g, { cc: b.cc });
  };
  ...
  var xoa = [
    { wo: 108.25, vo: 109.625, zo: 49, yo: 51.5 },
    { wo: 109.625, vo: 109.75, zo: 49, yo: 50.875 },
    { wo: 109.75, vo: 110.5, zo: 49, yo: 50.625 },
    { wo: 110.5, vo: 110.625, zo: 49, yo: 49.75 },
  ];
    ...
    a: {
      ...
      if (!(7 > c)) {
        ...
        for (var e = _.A(xoa), f = e.next(); !f.done; f = e.next())
          if (
            ((f = f.value), c >= f.wo && c <= f.vo && d >= f.zo && d <= f.yo)
          ) {
            c = !0;
            break a;
          }
  ...
  Wma.prototype.g = function (a) {
    ...
    1 == a
      ...
      ? Yma(this)
      : 4 == a &&
        ((this.fa.style.transitionDuration = "0.2s"),
        (this.fa.style.opacity = 0));
  };
  var yoa = null;
  ...
  yx.Iz = function (a, b, c, d) {
    ...
    c = Math.min(
      _.fn(c.width + 1e-12) - _.fn(a + 1e-12),
      _.fn(c.height + 1e-12) - _.fn(e + 1e-12)
    );
    d || (c = Math.floor(c));
    return c;
  };
  ...
  _.n.heading_changed = function () {
    if (!this.h) {
      ...
      if ("number" === typeof a) {
        ...
        a != b
          ? (this.set("heading", b), (this.o = a))
          : ((a = this.get("mapTypeId")), this.xk(a));
      }
    }
  };
  ...
  _.n.xk = function (a) {
    ...
    var d = this.get("tilt"),
      e = this.h;
    if (this.get("tilt") && !this.h && c && c instanceof lx && c.g && c.g[b])
      c = c.g[b];
    else if (0 == d && 0 != b && !e) {
      this.set("heading", 0);
      return;
    ...
    (c && c == this.H) ||
      (this.F && (_.ff(this.F), (this.F = null)),
      (b = (0, _.Qa)(this.xk, this, a)),
      a && (this.F = _.M(this.C, a.toLowerCase() + "_changed", b)),
      c && c instanceof _.uk
        ? ((a = c.g),
          this.set("styles", c.get("styles")),
          this.set("baseMapType", this.C.get(a)))
            ...
            (b = b.h.get()),
              ...
              (c =
                b == c
                  ...
                  ? b.scale == c.scale &&
                    b.Tf == c.Tf &&
                    (b.Ad == c.Ad ? !0 : b.Ad && c.Ad ? b.Ad.equals(c.Ad) : !1)
                  : !1);
          b = c;
        } else b = !1;
  ...
  xna.prototype.moveCamera = function (a) {
    ...
    if ((b || a.center) && e && d) {
      ...
      2 === this.o
        ...
        : 0 === this.o
        ? ((this.j = a.tilt), (this.h = a.heading))
        : (a.tilt || a.heading) &&
          console.warn(
      ...
      this.C.Pc({ center: a, zoom: c, heading: g, tilt: f }, !1);
    }
  };
  _.B(Fx, _.O);
  _.n = Fx.prototype;
  ...
  Ix.prototype.getBounds = function () {
    ...
    if (a && null != b) {
      ...
      a = { center: _.er(a, e), zoom: b, tilt: c, heading: d };
      a = this.ka.Ap(a);
      e = _.$ia(a, e, !0);
    } else e = null;
    return e;
  ...
  Jx.prototype.changed = function (a) {
    if ("apistyle" != a && "hasCustomStyles" != a) {
      ...
      for (var d = _.Zd(void 0, _.Od(b)), e = _.Zd(void 0, 0); e < d; ++e)
        c.push(b[e]);
      d = this.get("uDS")
      ...
      c.length &&
        (!d || 1e3 < d.length) &&
        _.ah(_.Pl(_.N, this, "styleerror", d.length));
      "styles" === a && Ena(this, b);
    }
  };
  ...
  Mx.prototype.changed = function (a) {
    "attributionText" !== a &&
      ("baseMapType" === a && (Ona(this), (this.D = null)), _.Ii(this.Ba));
  };
  Mx.prototype.O = function (a, b, c) {
    1 == _.H(c.m, 8) &&
      (0 !== c.getStatus() && _.pg(this.h, 14), this.V(_.I(c.m, 7, _.Yq), !1));
    if (a == this.F) {
      if (Lx(this) == b)
        try {
  ...
  Ox.prototype.ck = function (a) {
    ...
    a = new _.yj(
      Nx(a.g, this.bounds.min.g + e / 2, this.bounds.max.g - e / 2),
      Nx(a.h, this.bounds.min.h + f / 2, this.bounds.max.h - f / 2)
    );
    return { center: a, zoom: b, heading: d, tilt: c };
  };
  ...
  Px.prototype.update = function () {
    ...
    _.Wd(f)
      ...
      : _.Wd(e) && (b.max = Math.min(b.max, e));
    _.pe(function (g) {
      return g.min <= g.max;
    }, "minZoom cannot exceed maxZoom")(b);
    c = this.h.getBoundingClientRect();
    d = new Ox(a, b, { width: c.width, height: c.height }, this.j, d);
    this.h.cr(d);
  ...
  Ux.prototype.G = function (a) {
    ...
    if (!this.o.has(a)) {
      var c = [];
      c.push(
        _.M(a, "CLEAR_TARGET", function () {
          Qx(b, a);
        })
      );
      c.push(
        _.M(a, "UPDATE_FOCUS", function () {
          b.H(a);
        })
      );
      c.push(
        _.M(a, "REMOVE_FOCUS", function () {
          a.bm();
          Qx(b, a);
          Rx(b, a);
          var d = b.o.get(a);
      ...
      c.push(
        _.M(a, "ELEMENTS_REMOVED", function () {
          Qx(b, a);
          Rx(b, a);
        })
      );
      ...
      if (this.g && this.o) {
        ...
        if (1 == a.nodeType) {
          ...
          (b = a.changedTouches ? a.changedTouches[0] : a),
            (b = new _.jn(b.clientX, b.clientY));
  ...
  Zx.prototype.df = function (a, b) {
    ...
    if (!this.active) {
      ...
      d
        ? (this.active = { origin: a.ab, pC: this.ka.Dc().zoom, pf: d })
        : this.Kc.reset(b);
    }
  };
  Zx.prototype.ng = function (a) {
    if (this.active) {
      ...
      this.active.pf.fj({
        center: b.center,
        zoom:
          this.active.pC + (a.ab.clientY - this.active.origin.clientY) / 128,
        heading: b.heading,
        tilt: b.tilt,
      });
    }
  ...
  $x.prototype.df = function (a, b) {
    ...
    "none" === e ||
      ...
      (b.stop(),
      this.active
        ? (this.active.pg = Yna(this, a))
        : (this.cursor && _.Jv(this.cursor, !0),
          (d = iy(this.ka, function () {
            c.active = null;
            c.Kc.reset(b);
          }))
            ? (this.active = { pg: Yna(this, a), pf: d })
            : this.Kc.reset(b)));
  };
  $x.prototype.ng = function (a) {
    if (this.active) {
      ...
      if ("none" !== b) {
        var c = this.ka.Dc();
        b =
          "zoomaroundcenter" === b && 1 < a.De
            ? c.center
            : _.Cm(_.Bm(c.center, this.active.pg.ab), this.ka.qd(a.ab));
        this.active.pf.fj({
          center: b,
          zoom:
            this.active.pg.zoom +
  ...
  by.prototype.df = function (a, b) {
    ...
    if ("none" !== e && ("cooperative" !== e || !d))
      if ((b.stop(), this.active)) {
        if (
          ((d = cy(this, a)),
          (this.g = this.active.pg = d),
          (this.j = 0),
          (this.h = a.sh),
          2 === this.active.Bi || 3 === this.active.Bi)
        )
          this.active.Bi = 0;
      } else
        this.cursor && _.Jv(this.cursor, !0),
    ...
    if (this.active) {
      ...
      if ("none" !== b) {
        ...
        179 <= Math.round(Math.abs(d)) &&
          ((this.h = this.h < a.sh ? this.h + 360 : this.h - 360),
          (d = this.h - a.sh));
        this.j += d;
        ...
        if (1 === e || 2 === e || 3 === e) d = e;
          ...
          d = e
            ? 3
            : this.D &&
              (("cooperative" === b && 3 !== a.De) ||
              ("greedy" === b && 2 !== a.De)
                ? 0
                : 15 <= Math.abs(d.ab.clientY - a.ab.clientY) && 20 >= f)
            ? 2
            : 0;
        }
        d !== this.active.Bi &&
          ((this.active.Bi = d), (this.g = cy(this, a)), (this.j = 0));
        f = c.center;
        e = c.zoom;
        var g = c.heading,
          h = c.tilt;
        switch (d) {
          ...
          case 1:
            f =
              "zoomaroundcenter" === b && 1 < a.De
                ? c.center
                : _.Cm(_.Bm(c.center, this.g.Qm), this.ka.qd(a.ab));
        ...
        this.h = a.sh;
        this.active.pf.fj({ center: f, zoom: e, heading: g, tilt: h });
      }
    }
  };
  by.prototype.Ff = function () {
    ...
    this.cursor && _.Jv(this.cursor, !1);
    this.active &&
      (this.de(this.active.Bi),
      this.active.pf.release(this.g ? this.g.Qm : void 0));
    this.g = this.active = null;
    this.j = this.h = 0;
  };
  dy.prototype.df = function (a, b) {
    ...
    if (this.active) this.active.pg = $na(this, a);
      ...
      d ? (this.active = { pg: $na(this, a), pf: d }) : this.Kc.reset(b);
    }
  };
  ...
  boa.prototype.hb = function (a) {
    ...
    return {
      center: new _.yj(
        this.g.center.g * (1 - b) + this.Qa.center.g * b,
        this.g.center.h * (1 - b) + this.Qa.center.h * b
      ),
    ...
    if (!this.g) {
      ...
      this.g =
        ...
        (c < b.h
          ...
          : b.j + (c - b.h) / b.speed);
      return { done: 1, oa: this.kc.hb(0) };
    }
    a >= this.g
      ? (a = { done: 0, oa: this.kc.Qa })
      : ((b = this.easing),
        (a = this.g - a),
        (a = {
          done: 1,
  ...
  _.n.Pc = function (a, b) {
    ...
    this.oa && b
      ? this.Qg(
          this.D(this.Ca.getBoundingClientRect(!0), this.oa, a, function () {})
        )
      : this.Qg(eoa(a));
  };
  _.n.Bp = function () {
    return this.instructions
      ? this.instructions.kc
        ? this.instructions.kc.Qa
        : null
      : this.oa;
  };
  _.n.vn = function () {
  ...
  _.n.cr = function (a) {
    ...
    !this.instructions &&
      this.oa &&
      ((a = this.g.ck(this.oa)),
      (a.center === this.oa.center &&
        a.zoom === this.oa.zoom &&
        a.heading === this.oa.heading &&
        a.tilt === this.oa.tilt) ||
        this.Qg(eoa(a)));
  };
  _.n.ol = function () {
  ...
  _.n.Dl = function () {
    this.Ca.Dl();
    this.instructions && this.instructions.kc
      ? this.h(this.g.ck(this.instructions.kc.Qa))
      : this.oa && this.h(this.oa);
  };
  _.n = joa.prototype;
  _.n.tb = function (a) {
    var b = _.Oa(a);
  ...
  _.n.getBounds = function (a, b) {
    ...
    if (this.h) {
      ...
      b = this.h.dk(c, g, k, l, m, a, h);
      c = this.h.dk(c, e, k, l, m, a, h);
    } else
      (h = _.Bj(a.zoom, a.tilt, a.heading)),
        (f = _.Bm(a.center, _.Cj(h, { ba: b, da: g }))),
        (d = _.Bm(a.center, _.Cj(h, { ba: c, da: g }))),
        (c = _.Bm(a.center, _.Cj(h, { ba: c, da: e }))),
        (b = _.Bm(a.center, _.Cj(h, { ba: b, da: e })));
    return {
  ...
  _.n.Kb = function (a, b, c) {
    ...
    if ((f || this.h) && this.offset)
      this.origin = fma(e, _.Bm(d, _.Cj(e, this.offset)));
    else if (
      ((this.offset = _.Em(_.Fm(e, _.Cm(this.origin, d)))), (d = this.D))
    )
      (this.j.style[d] = this.o.style[d] =
        "translate(" + this.offset.ba + "px," + this.offset.da + "px)"),
        (this.j.style.willChange = this.o.style.willChange = "transform");
    d = _.Cm(this.origin, _.Cj(e, this.offset));
    f = this.getBounds(a);
    for (
      var g = this.getBoundingClientRect(!0),
        h = _.A(_.v(Object, "values").call(Object, this.Ca)),
        k = h.next();
      !k.done;
      k = h.next()
    )
      k.value.Kb(
        ...
        a.tilt,
        d,
        { ba: g.width, da: g.height },
        { cB: !0, Gh: !1, kc: c, timestamp: b }
      );
  };
  ...
  gy.prototype.hb = function () {
    return { oa: this.oa, done: this.cc ? 2 : 0 };
  };
  gy.prototype.fj = function (a) {
    ...
    this.g = { wc: b, oa: a };
    (0 < this.h.length && 10 > b - this.h.slice(-1)[0].wc) ||
      (this.h.push({ wc: b, oa: a }),
    ...
    if (!(0 >= this.h.length) && this.g) {
      ...
      switch (koa(this, d.oa, a)) {
        case 3:
          a = new ooa(
            this.g.oa,
            -180 + _.bn(this.g.oa.heading - d.oa.heading - -180, 360),
            e,
            c,
            a || this.g.oa.center
          );
  ...
  hy.prototype.hb = function (a) {
    a -= this.startTime;
    return { oa: this.kc.hb(a), done: a < this.kc.Ib ? 1 : 0 };
  };
  loa.prototype.hb = function (a) {
    ...
    return {
      center: _.Cm(
        this.Qa.center,
        new _.yj(this.g * a * a * a, this.h * a * a * a)
      ),
  ...
  _.n.Fw = function (a, b) {
    ...
    if ((d = 0 === hoa(this.controller) ? goa(this.controller) : this.Dc())) {
      ...
      (e && e.zoom === a) ||
        ((b = fy(d, a, b)),
        (c = this.h(this.g.getBoundingClientRect(!0), d, b, c)),
        (c.type = 0),
        this.controller.Qg(c));
    }
  };
  _.n.cr = function (a) {
    ...
    if (l) {
      ...
      k.then(function () {
        a.get("mapId") &&
          (_.Q(a, "MId"),
          _.P(a, 150505),
          a.get("mapId") === _.Vfa && (_.Q(a, "MDId"), _.P(a, 168942)));
      });
      ...
      var ja = ana({
        ...
        Eb = new _.Wr(function (ia, Fa) {
          ia = new _.Tr(p, 0, Pa, _.hs(ia), Fa, { al: !0 });
          Pa.tb(ia);
          return ia;
        }, Sa),
        Zc = _.js();
      ...
      h.F.then(function (ia) {
        (a.get("webgl") && _.Zi[15]) || mma(ia)
          ? (_.Q(a, "Wma"),
            _.P(a, 150152),
            _.Te("webgl").then(function (Fa) {
              var gb = !1,
      ...
      e({ map: a, ka: Pa, ui: b, Bd: m.Bd });
      h.C.then(function (ia) {
        ia ||
          _.Te("onion").then(function (Fa) {
            Fa.h(a, u);
          });
      });
      _.Zi[35] && (voa(a), woa(a));
      ...
      var vb = new _.gr(a, Pa, function () {
          ...
          if (vb.C && vb.o && vb.g && vb.j && vb.h) {
            if (vb.g.g) {
              ...
              (gb = _.Fm(vb.g, _.Cm(vb.C.min, vb.o))),
                (Fa = _.Fm(vb.g, _.Cm(vb.C.max, vb.o))),
                (gb = new _.R(gb.ba, gb.da)),
                (Fa = new _.R(Fa.ba, Fa.da));
            gb = new _.Ji([gb, Fa]);
          } else gb = null;
      ...
      d &&
        (_.zm(d.j, function () {
          ...
          Ha ||
            !ia ||
            Ga ||
            ((Ha = new _.Xv(p, -1, ia, Pa.ec)), d.h && _.Dj(d.h), Pa.tb(Ha));
        }),
        d.bindTo("tilt", h),
        d.bindTo("size", h));
      h.bindTo("zoom", a);
      ...
      a.set("tosUrl", _.ila);
      e = new Vx({ projection: 1 });
      e.bindTo("immutable", h, "baseMapType");
      k = new _.zv({ projection: new _.mj() });
      ...
      h.C.then(function (ia) {
        Ac.o = ia ? 2 : 1;
        if (void 0 !== Ac.j || void 0 !== Ac.h)
          Ac.moveCamera({ tilt: Ac.j, heading: Ac.h }),
            (Ac.j = void 0),
            (Ac.h = void 0);
      });
      var Ob = new Px(Pa, a);
