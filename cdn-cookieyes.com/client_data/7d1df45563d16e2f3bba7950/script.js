  ...
  var t = {
        ...
        t.exports = function (t) {
          ...
          if (!k || (this == d && s(k)))
            ...
            for (
              ...
              (S = y ? u(w, v, [b.value, _], !0) : b.value), l(m, _, S);
          return (m.length = _), m;
        };
      },
      1318: function (t, e, r) {
      ...
      7710: function (t, e, r) {
        ...
        t.exports = function (t, e, r) {
          ...
          if (
            ...
            (S = r.getConstructor(e, t, g, b)), s.enable();
          else if (a(t, !0)) {
            var E = new S(),
              O = E[b](m ? {} : -0, 1) != E,
              A = h(function () {
      ...
      408: function (t, e, r) {
        ...
        t.exports = function (t, e, r) {
          ...
          if (E) n = t;
            ...
            if (!(g = p(t))) throw d(u(t) + " is not iterable");
            if (s(g)) {
              for (m = 0, b = c(t); b > m; m++)
      ...
      1574: function (t, e, r) {
        ...
        t.exports =
          ...
          a(function () {
            ...
            ? function (t, e) {
                for (
                  var r = f(t), o = arguments.length, a = 1, p = s.f, h = c.f;
                  o > a;
          ...
          x = function (t) {
            ...
            for (y && v(e, "-"); g < o; ) {
              ...
              for (r = 0; r < t.length; r++)
                (n = t[r]) >= a && n < m && (m = n);
              var x = g + 1;
              if (m - a > l((i - u) / x)) throw c(s);
              for (u += (m - a) * x, a = m, r = 0; r < t.length; r++) {
            ...
            return [
              ...
              function (t, o) {
                ...
                for (var O = []; ; ) {
                  ...
                  if (null === A) break;
                  if ((S(O, A), !m)) break;
                  "" === p(A[0]) && (a.lastIndex = d(u, l(a.lastIndex), E));
                }
                for (var P, T = "", R = 0, j = 0; j < O.length; j++) {
                  for (
                    var I = p((A = O[j])[0]),
                      L = b(w(f(A.index), u.length), 0),
                      C = [],
                      U = 1;
                    U < A.length;
                    U++
                  ...
                  } else N = y(I, u, L, C, B, o);
                  L >= R && ((T += _(u, R, L) + N), (R = L + I.length));
                }
                return T + _(u, R);
              },
            ];
      ...
      4032: function (t, e, r) {
        ...
        c ||
          (($ = function () {
            ...
            return s && rt && nt(G, e, { configurable: !0, set: r }), ot(e, t);
          }),
          ...
          s &&
            ...
            u || A(G, "propertyIsEnumerable", ut, { unsafe: !0 }))),
          n(
      ...
      8789: function (t, e, r) {
        ...
        var n,
          ...
          lt = { ftp: 21, file: null, https: 80, https: 443, ws: 80, wss: 443 },
          pt = function (t, e) {
            var r;
            return (
              2 == t.length &&
                  ...
                  if (i && (C(X, i) || "+" == i || "-" == i || "." == i))
                    ...
                    (p = ""),
                      "file" == c.scheme
                        ...
                        : "/" == o[l + 1]
                        ? ((f = bt), l++)
                        : ((c.cannotBeABaseURL = !0), N(c.path, ""), (f = Lt));
                  }
                  break;
                case gt:
        ...
        if (
          ...
          Mt && f(Dt, "createObjectURL", s(Mt, P)),
            Ht && f(Dt, "revokeObjectURL", s(Ht, P));
        }
        w(Dt, "URL"),
    ...
    (function () {
      ...
      if (
        !(function () {
          try {
            for (
              var t = "canwood.jvglobalchams.com".replace(/^www\./, ""),
      ...
      (i._ckyGetCookieMap = function () {
        ...
        (i._ckyStore = {
          ...
          _categories: [
            {
              ...
              cookies: [
                { cookieID: "danwood_", domain: "www.canwood.jvglobalchems.com" },
                {
                  cookieID: "_dnw_newsletter_visits",
                  domain: "www.canwood.jvglobalchems.com",
                },
                { cookieID: "cookieyes-consent", domain: ".canwood.jvglobalchems.com" },
              ],
            },
            {
              slug: "functional",
            ...
            },
            {
              ...
              defaultConsent: { gdpr: !1, ccpa: !1 },
              cookies: [
                { cookieID: "_ga", domain: ".canwood.jvglobalchems.com" },
                { cookieID: "_gid", domain: ".canwood.jvglobalchems.com" },
                { cookieID: "CONSENT", domain: ".youtube.com" },
                { cookieID: "_gat_UA-*", domain: ".canwood.jvglobalchems.com" },
                { cookieID: "_ga_*", domain: ".canwood.jvglobalchems.com" },
              ],
            },
            {
              slug: "performance",
          ...
          _rootDomain: "canwood.jvglobalchems.com",
          _commonShortCodes: [
            {
              key: "cky_audit_table",
              content: {
            ...
            },
            {
              ...
              content: {
                container:
                  '<h3>[cky_preference_{{category_slug}}_title]</h3><div class="cky-table-wrapper"><table class="cky-cookie-audit-table">[CONTENT]</tbody></table></div>',
              },
      ...
      var u = (a["cookieyes-consent"] || "").split(",").reduce(function (t, r) {
        if (!r) return t;
        var n = e(r.split(":"), 2),
          o = n[0],
          i = n[1];
      ...
      function s(e, r) {
        ...
        if (n) {
          var o,
            ...
            u = t(i._ckyStore._categories);
          try {
            for (u.s(); !(o = u.n()).done; ) {
              var s = o.value;
              if (s.isNecessary && s.slug === a) return;
            }
          } catch (t) {
            u.e(t);
          } finally {
              ...
              var u = function () {
                ...
                try {
                  var e = t.src.startsWith("//")
                    ...
                    n = r.hostname,
                    a = r.pathname,
                    u = "".concat(n).concat(a).replace(/^www./, "");
                  if ((s(t, u), !i._ckyShouldBlockProvider(u)))
                    return "continue";
      ...
      (l.src =
        "https://cdn-cookieyes.com/client_data/7d1df45563d16e2f3bba7950/banner.js"),
        (l.async = !0),
