(function (g) {
  ...
  var lgb = function (a) {
    ...
    ngb = function (a) {
      g.V.call(this, { I: "div", S: "ytp-related-on-error-overlay" });
      var b = this;
      this.api = a;
      this.J = this.u = 0;
      this.D = new g.lI(this);
      this.j = [];
      this.suggestionData = [];
      ...
      this.suggestions = new g.V({ I: "div", S: "ytp-suggestions" });
      g.J(this, this.suggestions);
      this.suggestions.Ha(this.element);
      g.J(this, this.previous);
      this.previous.Ha(this.element);
      this.previous.Sa("click", this.OZ, this);
      g.J(this, this.ma);
      for (var c = { Bw: 0 }; 16 > c.Bw; c = { Bw: c.Bw }, c.Bw++) {
        var d = new g.V({
          I: "a",
        ...
        g.$m(e, "transitionDelay", c.Bw / 20 + "s");
        this.D.T(
          e,
          "click",
          (function (f) {
            return function (h) {
              ...
              b.api.N(
                ...
                ? (b.api.rb(b.j[l].element),
                  (l = m.Ck()),
                  (m = {}),
                  g.tJa(b.api, m, "emb_rel_err"),
                  (l = g.jj(l, m)),
                  g.JS(l, b.api, h))
                : g.IS(h, b.api, b.V, n || void 0) &&
                  b.api.Nn(m.videoId, n, m.playlistId);
            };
          })(c)
        );
        this.j.push(d);
      ...
      this.next.Sa("click", this.NZ, this);
    ...
    pgb = function (a) {
      ...
      g.bq(a.element, "ytp-scroll-min", 0 <= b);
      g.bq(a.element, "ytp-scroll-max", b <= c);
    },
    qgb = function (a) {
      for (var b = 0; b < a.suggestionData.length; b++) {
        ...
        if (
          ...
          var l = {};
          h.Ba && g.TR(l, h.loaderUrl);
          g.aS(a.api, "addEmbedsConversionTrackingParams", [l]);
          f = g.jj(f, g.SR(l, "emb_rel_err"));
        }
        d.element.style.display = "";
        l = d.Fa("ytp-suggestion-title");
        g.mq.test(c.title)
          ? (l.dir = "rtl")
          : g.g$a.test(c.title) && (l.dir = "ltr");
        l = d.Fa("ytp-suggestion-author");
        g.mq.test(e) ? (l.dir = "rtl") : g.g$a.test(e) && (l.dir = "ltr");
        d.update({
          views_or_author: e,
          duration: c.isLivePlayback
            ? "Live"
            : c.lengthSeconds
            ? g.dR(c.lengthSeconds)
            : "",
          link: f,
          hover_title: c.title,
          title: c.title,
        ...
        h.N("web_player_log_click_before_generating_ve_conversion_params") &&
          (a.api.Mf(d.element, d),
          (c = (c = c.sessionData) && c.itct) && a.api.Vf(d.element, c));
      }
    ...
    T5 = function (a) {
      ...
      c.B
        ? f.push("no-link")
        : ((c = g.uL(c)),
          a.N("web_player_add_ve_conversion_logging_to_outbound_links") ||
            (c = rgb(this, c)),
          (e.href = c),
          (e["aria-label"] = "Visit YouTube to search for more videos"));
      var h = new g.V({ I: "a", Ka: f, Y: e, X: [d] });
      h.Ha(this.element);
      a.N("web_player_add_ve_conversion_logging_to_outbound_links") &&
        (a.tb(h.element, this, 178053),
        this.T(h.element, "click", function (l) {
          sgb(b, l, h.element);
        }));
      g.J(this, h);
      a.W().B ||
        ((this.j = new ngb(a)), this.j.Ha(this.element), g.J(this, this.j));
    ...
    sgb = function (a, b, c) {
      b.preventDefault();
      a.api.W().B ||
        (a.api.rb(c), (b = c.getAttribute("href")), (b = rgb(a, b)), g.tk(b));
    },
    tgb = function (a, b) {
    ...
    wgb = function (a, b) {
      var c = a.api.W(),
        d;
      b.reason &&
        (ugb(b.reason) ? (d = g.CE(b.reason)) : (d = g.OT(g.BE(b.reason))),
        a.Yd(d, "content"));
      var e;
      b.subreason &&
        (ugb(b.subreason)
          ? (e = g.CE(b.subreason))
          : (e = g.OT(g.BE(b.subreason))),
        a.Yd(e, "subreason"));
      if (b.proceedButton && b.proceedButton.buttonRenderer) {
        ...
        if (
          ...
          ((e = b.text.simpleText),
          (f.textContent = e),
          !vgb(d, e) && (!c.B || c.embedsErrorLinks))
        ) {
          var h;
          c =
            null == (h = g.Q(null == b ? void 0 : b.navigationEndpoint, g.ZM))
              ? void 0
              : h.url;
          var l;
          h =
            null == (l = g.Q(null == b ? void 0 : b.navigationEndpoint, g.ZM))
              ? void 0
              : l.target;
          c &&
            (a.api.N("web_player_add_ve_conversion_logging_to_outbound_links")
              ? (f.setAttribute("href", c),
                a.api.tb(f, a, 178424),
                a.T(f, "click", function (m) {
                  sgb(a, m, f);
                }))
              : ((c = rgb(a, c)), f.setAttribute("href", c)));
    ...
    rgb = function (a, b) {
      var c = {},
        d = a.api.W();
      d.Ba && g.TR(c, d.loaderUrl);
      g.aS(a.api, "addEmbedsConversionTrackingParams", [c]);
      return g.cd(c) ? b : g.jj(b, c);
    },
    U5 = function (a, b) {
      g.V.call(this, {
        I: "a",
        ...
        X: [
          {
            ...
            X: [
              ...
              { I: "div", S: "ytp-impression-link-logo", X: [mgb()] },
            ],
          },
        ],
      });
      ...
      this.api.tb(this.element, this, 96714);
      this.T(this.api, "presentingplayerstatechange", this.Ki);
    ...
    xgb = function (a) {
      var b = {},
        c = a.api.W();
      c.Ba && g.TR(b, c.loaderUrl);
      g.aS(a.api, "addEmbedsConversionTrackingParams", [b]);
      return g.jj(a.api.getVideoUrl(), g.SR(b, "emb_imp_woyt"));
    },
    V5 = function (a) {
      g.V.call(this, {
        I: "div",
      ...
      this.api.tb(this.j, this, 141902);
      this.api.tb(this.forwardButton, this, 141903);
      this.T(this.api, "presentingplayerstatechange", this.Ki);
    ...
    W5 = function (a) {
        ...
        X: [
          {
            ...
            X: [{ I: "div", S: "ytp-muted-autoplay-end-text", xa: "{{text}}" }],
          },
        ],
      });
      this.api = a;
      this.C = this.Fa("ytp-muted-autoplay-end-panel");
      this.u = !1;
      this.api.tb(this.element, this, 52428);
      ...
      this.Sa("touchstart", this.onClick);
      this.hide();
    },
    X5 = function (a) {
      var b = a.W();
      g.V.call(this, {
        ...
        Y: {
          target: b.ea,
          href: "{{url}}",
          "aria-label": g.XO("Watch on $WEBSITE", { WEBSITE: g.hL(b) }),
      ...
      this.u = !1;
      this.state = a.Ib();
      a.tb(this.element, this, 76758);
      this.T(a, "videodatachange", this.HY);
      this.T(a, "videodatachange", this.onVideoDataChange);
      this.T(a, "presentingplayerstatechange", this.onStateChange);
      this.T(a, "appresize", this.Gb);
      this.xc(this.state);
      this.onVideoDataChange();
      this.Gb(a.kb().getPlayerSize());
    },
    Agb = function (a) {
      g.V.call(this, {
        I: "div",
      ...
      this.B = new g.Qp(this.X3, 4e3, this);
      this.u = !1;
      a.tb(this.element, this, 39306);
      this.T(a, "presentingplayerstatechange", this.YI);
      ...
      this.hide();
      g.fS(a.app) && (ygb(this), this.YI(), zgb(this));
    },
    zgb = function (a) {
      a.Bb && a.j && (a.j.show(), a.B.start());
    },
    ygb = function (a) {
      a.watermark ||
        ((a.watermark = new X5(a.api)),
        g.J(a, a.watermark),
        a.watermark.Ha(a.bottomButtons, 0),
        g.bq(a.watermark.element, "ytp-muted-autoplay-watermark", !0),
        (a.j = new g.VQ(a.watermark, 0, !0, 100)),
        g.J(a, a.j));
    },
    Bgb = function (a, b) {
      g.V.call(this, {
      ...
      this.expandButton = new g.V({
        ...
        xa: this.Yb() ? "More shorts" : "More videos",
      });
      "0" === a.W().controlsType &&
        g.Yp(a.getRootNode(), "ytp-pause-overlay-controls-hidden");
      g.J(this, this.B);
      g.J(this, this.D);
      var d = new g.V({
        I: "button",
        ...
        Y: {
          "aria-label": this.Yb() ? "Hide more shorts" : "Hide more videos",
        },
        X: [{ I: "div", S: "ytp-collapse-icon", X: [g.vDa()] }],
      });
      g.J(this, d);
      d.Ha(this.element);
      d.Sa("click", this.B5, this);
      g.J(this, this.expandButton);
      this.expandButton.Ha(this.element);
      this.expandButton.Sa("click", this.C5, this);
      this.j = new g.$2(a, b);
      g.J(this, this.j);
      this.j.B = !1;
      this.j.Ha(this.element);
      this.Yb()
        ? this.api.tb(this.element, this, 157212)
        : this.api.tb(this.element, this, 172777);
      this.B.T(this.api, "presentingplayerstatechange", this.Ra);
      this.B.T(this.api, "videodatachange", this.Ra);
      this.hide();
    },
    Y5 = function (a) {
      g.V.call(this, {
      ...
      this.api = a;
      this.J = this.Fa("ytp-svg-countdown-timer-ring");
      this.j = null;
      this.C = this.B = 0;
      this.u = !1;
      this.D = 0;
      this.api.tb(this.element, this, 159628);
    },
    Dgb = function (a) {
      a.j ||
        ((a.B = 5e3),
        (a.C = (0, g.gB)()),
        (a.j = new g.Op(function () {
          Cgb(a);
        }, null)),
        Cgb(a));
    },
    ...
    Hgb = function (a) {
      ...
      if (
        ...
        b = g.cS(a.G);
        if (a.G.W().N("shorts_mode_to_player_api") ? a.G.Yb() : b.Yb())
          (a.C = new g.V({
            I: "div",
            ...
            g.J(a, a.C),
            g.sS(a.G, a.C.element, 4),
            (a.u = new g.VQ(a.C, 1e3, !1, 100)),
            g.J(a, a.u),
            a.C.hide();
        a.B = new Bgb(a.G, b);
        g.J(a, a.B);
        ...
        g.J(a, a.D);
        g.sS(a.G, a.D.element, 4);
        Ggb(a, a.G.Ib());
      }
    },
    Ggb = function (a, b) {
      a.u &&
        ((!g.BO(b, 4) && !g.BO(b, 2)) || g.BO(b, 1024)
          ? a.u.hide()
          : a.u.show());
    },
    Egb = function (a) {
      var b = a.G,
        c;
      a = a.G.W().N("shorts_mode_to_player_api")
        ? !!b.Yb()
        : !(null == (c = g.cS(b)) || !c.Yb());
      g.bq(b.getRootNode(), "ytp-shorts-mode", a);
      if ((b = b.getVideoData())) b.zQ = a;
    },
    $5 = function (a, b) {
      a = {
        adSource: "EMBEDS_AD_SOURCE_YOUTUBE",
        breakType:
          0 === a.G.getCurrentTime()
            ? "EMBEDS_AD_BREAK_TYPE_PRE_ROLL"
            : 0 === a.G.getPlayerState()
            ? "EMBEDS_AD_BREAK_TYPE_POST_ROLL"
            : "EMBEDS_AD_BREAK_TYPE_MID_ROLL",
        embedUrl: g.hfa(a.G.W().loaderUrl),
        eventType: b,
        youtubeHost: g.dj(a.G.W().Oa) || "",
      };
      g.OA("embedsAdEvent", a);
    };
  g.x(ngb, g.V);
  g.k = ngb.prototype;
  g.k.hide = function () {
  ...
  g.k.resize = function (a, b) {
    ...
    if (150 >= Math.min(a.width, a.height) || 0 === h || !c.yd) this.hide();
      ...
      b &&
        ...
        50 < m &&
        ((q = Math.max(b, 50 / d)),
        (l = Math.ceil(a / (d * (q - 100) + this.u))),
        (m = a / l - this.u),
        (q = Math.floor(m / d)));
      50 > m || g.pS(this.api) ? this.hide() : this.show();
      for (b = 0; b < h; b++) {
        d = this.j[b];
        var t = d.Fa("ytp-suggestion-image");
        t.style.width = m + "px";
        t.style.height = q + "px";
  ...
  g.k.onVideoDataChange = function () {
    ...
    this.V = a.wd ? !1 : b.C;
    a.suggestions
      ? (this.suggestionData = g.fo(a.suggestions, function (c) {
    ...
    a.wd
      ? this.title.update({
          title: g.XO("More videos from $DNI_RELATED_CHANNEL", {
  ...
  g.k.scrollTo = function (a) {
    a = g.oe(
      a,
      this.containerWidth - this.suggestionData.length * (this.C + this.u),
      0
    );
    this.ma.start(this.B, a, 1e3);
    this.B = a;
    pgb(this);
    ogb(this, !0);
  };
  ...
  T5.prototype.show = function () {
    g.NT.prototype.show.call(this);
    tgb(this, this.api.kb().getPlayerSize());
  };
  T5.prototype.resize = function (a) {
    g.NT.prototype.resize.call(this, a);
    this.j &&
      (tgb(this, a),
      g.bq(
        this.element,
  ...
  T5.prototype.u = function (a) {
    g.NT.prototype.u.call(this, a);
    var b = this.api.getVideoData();
    if (b.MI || b.playerErrorMessageRenderer)
      (a = b.MI)
        ? wgb(this, a)
        : b.playerErrorMessageRenderer &&
          wgb(this, b.playerErrorMessageRenderer);
    else {
      var c;
      a.Mm &&
        (b.hx
  ...
  g.x(U5, g.V);
  U5.prototype.Ki = function () {
    this.api.Ib().isCued() || (this.hide(), this.api.Xa(this.element, !1));
  };
  U5.prototype.j = function () {
    var a = this.api.getVideoData(),
      b = this.api.W(),
      c = this.api.getVideoData().wd,
      d = b.Ed,
      e = !b.yd,
      f = this.u,
      h = b.N("shorts_mode_to_player_api") ? this.api.Yb() : f.Yb();
    f = f.ah();
    var l = g.XK(b);
    b = b.B;
    d || f || c || e || l || b || h || !a.videoId
      ? (this.hide(), this.api.Xa(this.element, !1))
      : ((a = xgb(this)), this.updateValue("url", a), this.show());
  };
  U5.prototype.onClick = function (a) {
  ...
  U5.prototype.show = function () {
    this.api.Ib().isCued() &&
      (g.V.prototype.show.call(this),
      this.api.Fk(this.element) && this.api.Xa(this.element, !0));
  };
  g.x(V5, g.V);
  V5.prototype.Ki = function () {
    var a = this.api.Ib();
    !this.api.Dh() || (g.BO(a, 2) && g.mS(this.api)) || g.BO(a, 64)
  ...
  W5.prototype.B = function () {
    ...
    this.api.W().N("embeds_enable_muted_autoplay") &&
      ...
      (g.BO(a, 2) && !this.Bb
        ? (this.show(),
          this.j ||
            ((this.j = new g.LT(this.api)),
            g.J(this, this.j),
            this.j.Ha(this.C, 0),
            this.j.show()),
          (a = this.api.getVideoData()),
          this.updateValue("text", a.CV),
          g.bq(this.element, "ytp-muted-autoplay-show-end-panel", !0),
          this.api.Xa(this.element, this.Bb),
          this.api.Pa("onMutedAutoplayEnds"))
        : this.hide());
  };
  W5.prototype.onClick = function () {
    if (!this.u) {
      this.j && (this.j.ra(), (this.j = null));
      g.bq(this.api.getRootNode(), "ytp-muted-autoplay", !1);
      var a = this.api.getVideoData(),
  ...
  g.k.HY = function () {
    var a = this.api.getVideoData(),
      b = this.api.getVideoData(1).wd,
      c = this.api.W();
    b = c.Ed && !g.BO(this.state, 2) && !(b && c.ma);
    a.mutedAutoplay || g.wQ(this, b);
  ...
  g.k.onVideoDataChange = function () {
    var a = this.api.W();
    a.B && g.Yp(this.element, "ytp-no-hover");
    this.api.getVideoData().videoId && !a.B
      ...
      : this.j &&
        (this.updateValue("url", null), this.Ic(this.j), (this.j = null));
  };
  g.k.onClick = function (a) {
    this.api.N("web_player_log_click_before_generating_ve_conversion_params") &&
      this.api.rb(this.element);
    var b = this.api.getVideoUrl(!g.eR(a), !1, !0, !0);
    if (
      this.api.N("web_player_log_click_before_generating_ve_conversion_params")
    ) {
      var c = {};
      g.aS(this.api, "addEmbedsConversionTrackingParams", [c]);
      b = g.jj(b, g.SR(c, "emb_yt_watermark"));
    }
    g.JS(b, this.api, a);
    this.api.N("web_player_log_click_before_generating_ve_conversion_params") ||
      this.api.rb(this.element);
  ...
  g.k.YI = function () {
    ...
    !g.BO(a, 2)
      ? this.Bb ||
        (g.V.prototype.show.call(this), this.api.Xa(this.element, this.Bb))
      : this.hide();
  };
  g.k.X3 = function () {
    this.j && this.j.hide();
  ...
  g.k.onMutedAutoplayEnds = function () {
    this.watermark && (this.watermark.ra(), (this.watermark = null));
  };
  g.x(Bgb, g.V);
  g.k = Bgb.prototype;
  g.k.hide = function () {
    g.$p(this.api.getRootNode(), "ytp-expand-pause-overlay");
    g.V.prototype.hide.call(this);
  };
  g.k.Yb = function () {
    return this.api.W().N("shorts_mode_to_player_api")
      ? this.api.Yb()
      : this.C.Yb();
  };
  g.k.B5 = function () {
    this.u = !0;
    g.$p(this.api.getRootNode(), "ytp-expand-pause-overlay");
    this.C.Yb() && this.api.Xa(this.element, !1);
    this.expandButton.focus();
  };
  g.k.C5 = function () {
    this.u = !1;
    g.Yp(this.api.getRootNode(), "ytp-expand-pause-overlay");
    this.C.Yb() && this.api.Xa(this.element, !0);
    this.focus();
  };
  g.k.Ra = function (a) {
    a = this.api.W().N("embeds_web_enable_pause_overlay_wn_update")
      ? this.api.Ib()
      : a.state;
    g.BO(a, 1) ||
      g.BO(a, 16) ||
      g.BO(a, 32) ||
      (!g.BO(a, 4) || g.BO(a, 2) || g.BO(a, 1024)
        ? (this.u || this.api.Xa(this.element, !1), this.D.hide())
  ...
  Y5.prototype.ra = function () {
    Z5(this);
    g.V.prototype.ra.call(this);
  };
  g.x(Fgb, g.uT);
  g.k = Fgb.prototype;
  g.k.Yk = function () {
  ...
  g.k.create = function () {
    var a = this.G.W(),
      b = g.cS(this.G),
      c,
      d = null == (c = this.G.getVideoData()) ? void 0 : c.clientPlaybackNonce;
    d && g.uF({ clientPlaybackNonce: d });
    Hgb(this);
    a.N("embeds_enable_muted_autoplay") &&
      ((this.V = new Agb(this.G)),
      g.J(this, this.V),
      g.sS(this.G, this.V.element, 4),
      (this.qa = new W5(this.G)),
      g.J(this, this.qa),
      g.sS(this.G, this.qa.element, 4));
    a.Ed &&
      ((this.watermark = new X5(this.G)),
      g.J(this, this.watermark),
      g.sS(this.G, this.watermark.element, 8));
    this.J = new U5(this.G, b);
    g.J(this, this.J);
    g.sS(this.G, this.J.element, 8);
    g.fS(this.G.app) && (this.onMutedAutoplayStarts(), this.J.hide());
    a.u &&
      ((this.ma = new V5(this.G)),
      g.J(this, this.ma),
      g.sS(this.G, this.ma.element, 4));
    this.j.T(this.G, "appresize", this.Gb);
    this.j.T(this.G, "presentingplayerstatechange", this.Ki);
    this.j.T(this.G, "videodatachange", this.onVideoDataChange);
    this.j.T(this.G, "videoplayerreset", this.Iv);
    ...
    if ((this.K = g.Mz(g.eL(a))))
      (this.countdownTimer = new Y5(this.G)),
        g.J(this, this.countdownTimer),
        g.sS(this.G, this.countdownTimer.element, 4),
        this.countdownTimer.hide(),
        this.j.T(this.G, g.uE("embeds"), this.onCueRangeEnter),
        this.j.T(this.G, g.vE("embeds"), this.onCueRangeExit);
    this.wc(this.G.Ib());
    this.player.rg("embed");
  };
  g.k.onCueRangeEnter = function (a) {
    "countdown timer" === a.getId() &&
      this.countdownTimer &&
      (this.countdownTimer.show(), Dgb(this.countdownTimer));
  };
  g.k.onCueRangeExit = function (a) {
    "countdown timer" === a.getId() &&
      this.countdownTimer &&
      (Z5(this.countdownTimer), this.countdownTimer.hide());
  };
  g.k.Gb = function () {
    var a = this.G.kb().getPlayerSize();
  ...
  g.k.wc = function (a) {
    g.BO(a, 128)
      ? (this.xg ||
          ((this.xg = new T5(this.G)),
          g.J(this, this.xg),
          g.sS(this.G, this.xg.element, 4)),
        this.xg.u(a.getData()),
        this.xg.show(),
        g.Yp(this.G.getRootNode(), "ytp-embed-error"))
      : this.xg &&
        (this.xg.dispose(),
        (this.xg = null),
        g.$p(this.G.getRootNode(), "ytp-embed-error"));
    if (this.countdownTimer && this.countdownTimer.j)
      if (g.BO(a, 64)) this.countdownTimer.hide(), Z5(this.countdownTimer);
      else if (g.wP(a)) {
        var b = this.countdownTimer;
        b.u || ((b.u = !0), (b.D = (0, g.gB)()));
      } else
        a.hd() &&
          this.countdownTimer.u &&
          ((b = this.countdownTimer),
          b.u && ((b.C += (0, g.gB)() - b.D), (b.u = !1), Cgb(b)));
    Ggb(this, a);
  };
  g.k.onMutedAutoplayStarts = function () {
    this.G.getVideoData().mutedAutoplay &&
      this.V &&
      g.bq(this.G.getRootNode(), "ytp-muted-autoplay", !0);
  };
  g.k.onVideoDataChange = function (a, b) {
    ...
    var d,
      e = {
        isShortsModeEnabled: this.G.W().N("shorts_mode_to_player_api")
          ? this.G.Yb()
          : null == (d = g.cS(this.G))
          ? void 0
          : d.Yb(),
      };
    g.OA("embedsVideoDataDidChange", {
    ...
    c &&
      ...
      this.K &&
        ...
        b.isAd() ||
          5 > b.endSeconds ||
          g.pS(this.G) ||
          ((b = Math.max(1e3 * (b.endSeconds - 5), 0)),
          (b = new g.sE(b, b + 5e3, {
            id: "countdown timer",
            namespace: "embeds",
          })),
      ...
      Egb(this),
      Hgb(this));
    this.G.W().B && this.B && this.B.detach();
  };
  g.k.onAdStart = function () {
    $5(this, "EMBEDS_AD_EVENT_TYPE_AD_STARTED");
  };
  g.k.onAdComplete = function () {
    $5(this, "EMBEDS_AD_EVENT_TYPE_AD_COMPLETED");
  };
  g.k.onAdSkip = function () {
    $5(this, "EMBEDS_AD_EVENT_TYPE_AD_SKIPPED");
  };
  g.k.onAdStateChange = function (a) {
    2 === a && $5(this, "EMBEDS_AD_EVENT_TYPE_AD_PAUSED");
  };
  g.tT("embed", Fgb);
})(_yt_player);
