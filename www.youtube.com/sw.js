/** 6526809462069127058 */ self.document = self;
self.window = self;
var ytcfg = {
  d: function () {
...
ytcfg.set({
  EXPERIMENT_FLAGS: {
    ...
    web_async_context_processor_impl: "hybrid",
  ...
  INNERTUBE_CLIENT_VERSION: "2.20230525.00.00",
  INNERTUBE_CONTEXT: {
    client: { clientName: "WEB", clientVersion: "2.20230525.00.00" },
  },
  INNERTUBE_CONTEXT_CLIENT_NAME: 1,
  INNERTUBE_CONTEXT_CLIENT_VERSION: "2.20230525.00.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
  const swPolicy = trustedTypes.createPolicy("youtubeServiceWorkerPolicy", {
    createScriptURL: function (ignored) {
      return "https://www.youtube.com/s/desktop/339bae71/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js";
    },
  });
  importScripts(swPolicy.createScriptURL(""));
} else {
  importScripts(
    "https://www.youtube.com/s/desktop/339bae71/jsbin/serviceworker-kevlar-appshell.vflset/serviceworker-kevlar-appshell.js"
  );
}
