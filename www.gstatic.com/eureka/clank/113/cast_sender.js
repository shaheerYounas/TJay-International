...
*/
  ...
  t("chrome.cast.VERSION", chrome.cast.VERSION);
  chrome.cast.tc = !0;
  t("chrome.cast.usingPresentationApi", chrome.cast.tc);
  chrome.cast.Oa = function (a, b) {
    this.credentials = a;
    this.credentialsType = void 0 === b ? "web" : b;
  };
  t("chrome.cast.CredentialsData", chrome.cast.Oa);
  chrome.cast.Error = function (a, b, c) {
    this.code = a;
    this.description = b || null;
    this.details = c || null;
  };
  t("chrome.cast.Error", chrome.cast.Error);
  chrome.cast.rb = function (a) {
    this.platform = a;
    this.packageId = this.url = null;
  };
  t("chrome.cast.SenderApplication", chrome.cast.rb);
  chrome.cast.Image = function (a) {
    this.url = a;
    this.width = this.height = null;
  };
  t("chrome.cast.Image", chrome.cast.Image);
  chrome.cast.Volume = function (a, b) {
    this.level = void 0 === a ? null : a;
    this.muted = void 0 === b ? null : b;
  };
  t("chrome.cast.Volume", chrome.cast.Volume);
  chrome.cast.ha = {
  ...
  t("chrome.cast.AutoJoinPolicy", chrome.cast.ha);
  chrome.cast.ka = {
    CREATE_SESSION: "create_session",
    CAST_THIS_TAB: "cast_this_tab",
  };
  t("chrome.cast.DefaultActionPolicy", chrome.cast.ka);
  chrome.cast.Na = {
    VIDEO_OUT: "video_out",
    AUDIO_OUT: "audio_out",
    VIDEO_IN: "video_in",
  ...
  t("chrome.cast.Capability", chrome.cast.Na);
  chrome.cast.C = {
    CANCEL: "cancel",
    TIMEOUT: "timeout",
  ...
  t("chrome.cast.ErrorCode", chrome.cast.C);
  chrome.cast.O = { AVAILABLE: "available", UNAVAILABLE: "unavailable" };
  t("chrome.cast.ReceiverAvailability", chrome.cast.O);
  chrome.cast.sb = { CHROME: "chrome", IOS: "ios", ANDROID: "android" };
  t("chrome.cast.SenderPlatform", chrome.cast.sb);
  chrome.cast.ya = {
    CAST: "cast",
    DIAL: "dial",
    HANGOUT: "hangout",
  ...
  t("chrome.cast.ReceiverType", chrome.cast.ya);
  chrome.cast.Qa = { RUNNING: "running", STOPPED: "stopped", ERROR: "error" };
  t("chrome.cast.DialAppState", chrome.cast.Qa);
  chrome.cast.nb = { CAST: "cast", STOP: "stop" };
  t("chrome.cast.ReceiverAction", chrome.cast.nb);
  chrome.cast.L = {
    CONNECTED: "connected",
    DISCONNECTED: "disconnected",
    STOPPED: "stopped",
  };
  t("chrome.cast.SessionStatus", chrome.cast.L);
  chrome.cast.Gb = {
    ATTENUATION: "attenuation",
    FIXED: "fixed",
    MASTER: "master",
  };
  t("chrome.cast.VolumeControlType", chrome.cast.Gb);
  function u(a, b) {
  ...
  var wa = Array.prototype.forEach
    ? function (a, b) {
  ...
  var Fa, x;
  a: {
    for (var Ga = ["CLOSURE_FLAGS"], y = p, Ha = 0; Ha < Ga.length; Ha++)
      if (((y = y[Ga[Ha]]), null == y)) {
        x = null;
        break a;
      }
  ...
  var z,
    Ka = p.navigator;
  z = Ka ? Ka.userAgentData || null : null;
  function La(a) {
    return Fa
      ? z
  ...
  function B() {
    return Fa ? !!z && 0 < z.brands.length : !1;
  }
  function Ma() {
    return B()
      ? La("Chromium")
  ...
  var Oa = function (a) {
      ...
      va("expected object of type SafeHtml, got '" + a + "' of type " + ma(a));
      return "type_error:SafeHtml";
    },
    Pa = new C((p.trustedTypes && p.trustedTypes.emptyHTML) || "", Na);
  var Qa = { MATH: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 },
    Ra = (function (a) {
      var b = !1,
        c;
      return function () {
  ...
  var Ta = function (a) {
      ...
      return a.replace(Sa, function (d, e) {
        var g = b[d];
        if (g) return g;
        "#" == e.charAt(0) &&
        ...
        if (!g) {
          ...
          g = (e = v) ? e.createHTML(g) : g;
          g = new C(g, Na);
          if (c.tagName && Qa[c.tagName.toUpperCase()])
            throw Error(
              "goog.dom.safe.setInnerHtml cannot be used to set content of " +
                c.tagName +
                "."
            );
          if (Ra()) for (; c.lastChild; ) c.removeChild(c.lastChild);
          c.innerHTML = Oa(g);
  ...
  t("chrome.cast.ApiConfig", chrome.cast.Ja);
  chrome.cast.Ta = function (a, b) {
    this.appName = a;
    this.launchParameter = b || null;
  };
  t("chrome.cast.DialRequest", chrome.cast.Ta);
  chrome.cast.Ra = function (a, b, c) {
    this.receiver = a;
    this.appState = b;
    this.extraData = c || null;
  };
  t("chrome.cast.DialLaunchData", chrome.cast.Ra);
  chrome.cast.Sa = function (a, b) {
    this.doLaunch = a;
    this.launchParameter = b || null;
  };
  t("chrome.cast.DialLaunchResponse", chrome.cast.Sa);
  ...
  t("chrome.cast.SessionRequest", chrome.cast.tb);
  ...
  t("chrome.cast.Receiver", chrome.cast.mb);
  chrome.cast.ob = function (a, b) {
    this.statusText = a;
    this.appImages = b;
    this.showStop = null;
  };
  t("chrome.cast.ReceiverDisplayStatus", chrome.cast.ob);
  ...
  t("chrome.cast.media.HlsSegmentFormat", chrome.cast.media.Za);
  chrome.cast.media.ab = { MPEG2_TS: "mpeg2_ts", FMP4: "fmp4" };
  t("chrome.cast.media.HlsVideoSegmentFormat", chrome.cast.media.ab);
  ...
  t("chrome.cast.media.MediaCommand", chrome.cast.media.eb);
  ...
  t("chrome.cast.media.QueueType", chrome.cast.media.kb);
  chrome.cast.media.U = { GENERIC_CONTAINER: 0, AUDIOBOOK_CONTAINER: 1 };
  t("chrome.cast.media.ContainerType", chrome.cast.media.U);
  chrome.cast.media.G = {
    GENERIC: 0,
    MOVIE: 1,
    TV_SHOW: 2,
  ...
  t("chrome.cast.media.MetadataType", chrome.cast.media.G);
  chrome.cast.media.F = {
    IDLE: "IDLE",
    PLAYING: "PLAYING",
    PAUSED: "PAUSED",
  ...
  t("chrome.cast.media.PlayerState", chrome.cast.media.F);
  chrome.cast.media.V = {
    OFF: "REPEAT_OFF",
    ALL: "REPEAT_ALL",
  ...
  t("chrome.cast.media.RepeatMode", chrome.cast.media.V);
  chrome.cast.media.pb = {
    PLAYBACK_START: "PLAYBACK_START",
    PLAYBACK_PAUSE: "PLAYBACK_PAUSE",
  };
  t("chrome.cast.media.ResumeState", chrome.cast.media.pb);
  chrome.cast.media.Aa = { BUFFERED: "BUFFERED", LIVE: "LIVE", OTHER: "OTHER" };
  t("chrome.cast.media.StreamType", chrome.cast.media.Aa);
  ...
  t("chrome.cast.media.IdleReason", chrome.cast.media.bb);
  chrome.cast.media.Bb = { TEXT: "TEXT", AUDIO: "AUDIO", VIDEO: "VIDEO" };
  t("chrome.cast.media.TrackType", chrome.cast.media.Bb);
  ...
  t("chrome.cast.media.TextTrackType", chrome.cast.media.yb);
  ...
  t("chrome.cast.media.TextTrackEdgeType", chrome.cast.media.ub);
  chrome.cast.media.zb = {
    NONE: "NONE",
    NORMAL: "NORMAL",
    ROUNDED_CORNERS: "ROUNDED_CORNERS",
  };
  t("chrome.cast.media.TextTrackWindowType", chrome.cast.media.zb);
  ...
  t("chrome.cast.media.TextTrackFontGenericFamily", chrome.cast.media.vb);
  ...
  t("chrome.cast.media.TextTrackFontStyle", chrome.cast.media.wb);
  ...
  t("chrome.cast.media.UserAction", chrome.cast.media.Cb);
  chrome.cast.media.ma = function () {
    this.customData = null;
  };
  t("chrome.cast.media.GetStatusRequest", chrome.cast.media.ma);
  chrome.cast.media.qa = function () {
    this.customData = null;
  };
  t("chrome.cast.media.PauseRequest", chrome.cast.media.qa);
  chrome.cast.media.sa = function () {
    this.customData = null;
  };
  t("chrome.cast.media.PlayRequest", chrome.cast.media.sa);
  chrome.cast.media.qb = function () {
    this.customData = this.resumeState = this.currentTime = null;
  };
  t("chrome.cast.media.SeekRequest", chrome.cast.media.qb);
  chrome.cast.media.za = function () {
    this.customData = null;
  };
  t("chrome.cast.media.StopRequest", chrome.cast.media.za);
  chrome.cast.media.Hb = function (a) {
    this.volume = a;
    this.customData = null;
  };
  t("chrome.cast.media.VolumeRequest", chrome.cast.media.Hb);
  ...
  t("chrome.cast.media.LoadRequest", chrome.cast.media.cb);
  chrome.cast.media.hb = function (a) {
    this.type = "PRECACHE";
    this.requestId = 0;
    this.precacheData = a;
  ...
  t("chrome.cast.media.EditTracksInfoRequest", chrome.cast.media.Ua);
  ...
  t("chrome.cast.media.ContainerMetadata", chrome.cast.media.T);
  ...
  t("chrome.cast.media.MediaMetadata", chrome.cast.media.MediaMetadata);
  ...
  n(chrome.cast.media.la, chrome.cast.media.MediaMetadata);
  t("chrome.cast.media.GenericMediaMetadata", chrome.cast.media.la);
  ...
  t("chrome.cast.media.MovieMediaMetadata", chrome.cast.media.oa);
  ...
  n(chrome.cast.media.Ca, chrome.cast.media.MediaMetadata);
  t("chrome.cast.media.TvShowMediaMetadata", chrome.cast.media.Ca);
  ...
  n(chrome.cast.media.pa, chrome.cast.media.MediaMetadata);
  t("chrome.cast.media.MusicTrackMediaMetadata", chrome.cast.media.pa);
  ...
  n(chrome.cast.media.ra, chrome.cast.media.MediaMetadata);
  t("chrome.cast.media.PhotoMediaMetadata", chrome.cast.media.ra);
  ...
  t("chrome.cast.media.AudiobookContainerMetadata", chrome.cast.media.ga);
  ...
  t("chrome.cast.media.AudiobookChapterMediaMetadata", chrome.cast.media.fa);
  ...
  t("chrome.cast.media.MediaInfo", chrome.cast.media.fb);
  ...
  t("chrome.cast.media.QueueItem", chrome.cast.media.ua);
  chrome.cast.media.Pa = "CC1AD845";
  t("chrome.cast.media.DEFAULT_MEDIA_RECEIVER_APP_ID", chrome.cast.media.Pa);
  chrome.cast.media.timeout = {};
  chrome.cast.media.timeout.load = 0;
  t("chrome.cast.media.timeout.load", chrome.cast.media.timeout.load);
  chrome.cast.media.timeout.R = 0;
  t("chrome.cast.media.timeout.getStatus", chrome.cast.media.timeout.R);
  chrome.cast.media.timeout.play = 0;
  t("chrome.cast.media.timeout.play", chrome.cast.media.timeout.play);
  chrome.cast.media.timeout.pause = 0;
  t("chrome.cast.media.timeout.pause", chrome.cast.media.timeout.pause);
  chrome.cast.media.timeout.seek = 0;
  t("chrome.cast.media.timeout.seek", chrome.cast.media.timeout.seek);
  chrome.cast.media.timeout.stop = 0;
  t("chrome.cast.media.timeout.stop", chrome.cast.media.timeout.stop);
  chrome.cast.media.timeout.S = 0;
  t("chrome.cast.media.timeout.setVolume", chrome.cast.media.timeout.S);
  chrome.cast.media.timeout.P = 0;
  t("chrome.cast.media.timeout.editTracksInfo", chrome.cast.media.timeout.P);
  chrome.cast.media.timeout.v = 0;
  t("chrome.cast.media.timeout.queue", chrome.cast.media.timeout.v);
  ...
  t("chrome.cast.media.Track", chrome.cast.media.Ab);
  ...
  t("chrome.cast.media.TextTrackStyle", chrome.cast.media.xb);
  ...
  t("chrome.cast.media.QueueLoadRequest", chrome.cast.media.jb);
  ...
  t("chrome.cast.media.QueueInsertItemsRequest", chrome.cast.media.ta);
  ...
  t("chrome.cast.media.QueueUpdateItemsRequest", chrome.cast.media.lb);
  ...
  t("chrome.cast.media.QueueJumpRequest", chrome.cast.media.N);
  chrome.cast.media.xa = function () {
    this.type = "QUEUE_UPDATE";
    this.customData = this.repeatMode = this.sessionId = this.requestId = null;
  };
  t("chrome.cast.media.QueueSetPropertiesRequest", chrome.cast.media.xa);
  ...
  t("chrome.cast.media.QueueRemoveItemsRequest", chrome.cast.media.va);
  ...
  t("chrome.cast.media.QueueReorderItemsRequest", chrome.cast.media.wa);
  ...
  t("chrome.cast.media.Break", chrome.cast.media.Ka);
  ...
  t("chrome.cast.media.BreakClip", chrome.cast.media.La);
  chrome.cast.media.Eb = function () {
    this.adsResponse = this.adTagUrl = void 0;
  };
  t("chrome.cast.media.VastAdsRequest", chrome.cast.media.Eb);
  chrome.cast.media.Ma = function () {
    this.whenSkippable =
      this.breakClipId =
      this.breakId =
  ...
  t("chrome.cast.media.BreakStatus", chrome.cast.media.Ma);
  ...
  t("chrome.cast.media.LiveSeekableRange", chrome.cast.media.na);
  ...
  t("chrome.cast.media.QueueData", chrome.cast.media.ib);
  chrome.cast.media.Db = function (a) {
    this.userAction = a;
    this.customData = void 0;
  };
  t("chrome.cast.media.UserActionState", chrome.cast.media.Db);
  chrome.cast.media.Fb = function (a, b, c) {
    this.width = a;
    this.height = b;
    this.hdrType = c;
  };
  t("chrome.cast.media.VideoInformation", chrome.cast.media.Fb);
  var D = null;
  ...
  var Va = function (a, b) {
    return xa(a.items, function (c) {
      return c.itemId == b;
    });
  };
  t("chrome.cast.media.Media", chrome.cast.media.i);
  ...
  f.qc = function (a, b, c) {
    var d = D;
    a = new Xa(new chrome.cast.Volume(a, null), this.receiver.volume);
    d.setReceiverVolume(this.sessionId, a, b, c);
  };
  f.pc = function (a, b, c) {
    a = new Xa(new chrome.cast.Volume(null, a), this.receiver.volume);
    D.setReceiverVolume(this.sessionId, a, b, c);
  };
  ...
  f.stop = function (a, b) {
    D.Ea(new Ya(this.sessionId), a, b, chrome.cast.timeout.stopSession);
  };
  f.sendMessage = function (a, b, c, d) {
    D.mc(new Wa(this.sessionId, a, b), c, d);
  };
  f.Y = function (a) {
  ...
  t("chrome.cast.Session", chrome.cast.l);
  ...
  f.keys = function () {
    return db(this.s(!0)).h();
  };
  f.values = function () {
    return db(this.s(!1)).h();
  };
  f.entries = function () {
    var a = this;
    return $a(this.keys(), function (b) {
      return [b, a.get(b)];
    });
  };
  f.s = function (a) {
  ...
  P.prototype.connect = function (a) {
    this.g = a;
    this.g.onmessage = r(this.m, this);
    jb(this, new O("client_connect", this.h));
  };
  ...
  var mb = function (a, b, c, d, e, g, k, l, q, w, tb, ub) {
      this.J = a;
      this.g = b || null;
      this.j = c || null;
      this.B = d || null;
    ...
    nb = function (a) {
      ...
      a.h && b.push(lb(new kb(a.h, a.I, a.g)));
      return b;
    };
  var ob = function () {
      this.g = {};
  ...
  var vb =
      A("Gecko") &&
      !(-1 != Ja().toLowerCase().indexOf("webkit") && !A("Edge")) &&
      !(A("Trident") || A("MSIE")) &&
      !A("Edge"),
    wb = -1 != Ja().toLowerCase().indexOf("webkit") && !A("Edge");
  try {
  ...
  var xb = function (a, b) {
    if ("function" !== typeof a)
      if (a && "function" == typeof a.handleEvent) a = r(a.handleEvent, a);
  ...
  R.prototype.A = function (a) {
    this.m = arguments;
    this.g || this.j ? (this.h = !0) : yb(this);
  };
  R.prototype.stop = function () {
    this.g &&
      (p.clearTimeout(this.g), (this.g = null), (this.h = !1), (this.m = null));
  };
  ...
  R.prototype.resume = function () {
    this.j--;
    this.j || !this.h || this.g || ((this.h = !1), yb(this));
  };
  var yb = function (a) {
    a.g = xb(function () {
      a.g = null;
  ...
  A("Safari") &&
    (Ma() ||
      ...
      (B() ? 0 : A("Opera")) ||
      (B() ? 0 : A("Edge")) ||
      (B() ? La("Microsoft Edge") : A("Edg/")) ||
      (B() && La("Opera")));
  var zb = {},
    S = null,
    Ab = vb || wb || "function" == typeof p.btoa,
    Bb = function (a) {
      if (Ab) var b = p.btoa(a);
      else {
        b = [];
  ...
  var T = function () {
    ...
    U = function (a) {
      ...
      return ("object" == b && a) || "function" == b
        ? "o" +
            ((Object.prototype.hasOwnProperty.call(a, oa) && a[oa]) ||
              (a[oa] = ++pa))
        : b.slice(0, 1) + a;
    };
  f = T.prototype;
  ...
  V.prototype.initialize = function (a, b) {
    ...
    a.invisibleSender ||
      ...
      (this.ia = (p.navigator || null).presentation.defaultRequest = a),
  ...
  var Y = function (a, b, c) {
      ...
      b.onclose = function (d) {
        ...
        switch (d.reason) {
          case "closed":
            Eb(a, chrome.cast.L.DISCONNECTED);
            break;
          case "error":
            c &&
  ...
  var X = function (a, b, c, d) {
    ...
    var k = b.dialRequest;
    k &&
      ((e = k.appName), (g = k.launchParameter) && !g.match(Ib) && (g = Bb(g)));
    var l = [];
    l.push({ appId: b.appId, capabilities: b.capabilities });
    b ||
      wa(a.g.additionalSessionRequests, function (q) {
        l.push({ appId: q.appId, capabilities: q.capabilities });
      });
    return nb(
      new mb(
        l,
  ...
  V.prototype.onMessage = function (a) {
    ...
    if ((b = ib(this.K, a.sequenceNumber)))
  ...
  t("chrome.cast.initialize", chrome.cast.initialize);
  chrome.cast.da = function (a) {
    Z.da(a);
  };
  t("chrome.cast.setPageContext", chrome.cast.da);
  chrome.cast.requestSession = function (a, b, c) {
    Z.requestSession(a, b, c);
  };
  t("chrome.cast.requestSession", chrome.cast.requestSession);
  chrome.cast.Ub = function (a) {
    Hb(new chrome.cast.media.hb(a));
  };
  t("chrome.cast.precache", chrome.cast.Ub);
  chrome.cast.ca = function (a) {
    Z.ca(a);
  };
  t("chrome.cast.requestSessionById", chrome.cast.ca);
  chrome.cast.X = function (a) {
    Z.X(a);
  };
  t("chrome.cast.addReceiverActionListener", chrome.cast.X);
  chrome.cast.aa = function (a) {
    Z.aa(a);
  };
  t("chrome.cast.removeReceiverActionListener", chrome.cast.aa);
  chrome.cast.Tb = function () {};
  t("chrome.cast.logMessage", chrome.cast.Tb);
  chrome.cast.nc = function (a, b) {
    b();
  };
  t("chrome.cast.setCustomReceivers", chrome.cast.nc);
  chrome.cast.oc = function (a, b) {
    b();
  };
  t("chrome.cast.setReceiverDisplayStatus", chrome.cast.oc);
  chrome.cast.unescape = function (a) {
    return -1 != a.indexOf("&") ? ("document" in p ? Ta(a) : Ua(a)) : a;
  };
  t("chrome.cast.unescape", chrome.cast.unescape);
  chrome.cast.isAvailable = !1;
  t("chrome.cast.isAvailable", chrome.cast.isAvailable);
  chrome.cast.Ga = !1;
